<?php 
    ...
    Utils::print_header(
        "Why Now?",
        "Why Now? - Develop Everything's introduction."
    );
?>
...
<div id="content">
    ...
    <p>
        Around the time all of this was culminating, I was making the rounds on the sites I like to check once in a while, and noticed that Fabien Sanglard had a new look to his site, complimented with a <a href="http://fabiensanglard.net/bloated/index.html">post</a> explaining his cause for redesign.
    </p>
    <p>
